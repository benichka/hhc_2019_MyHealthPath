  ...
  //      });
    ...
    getBubbleById(id) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!id) {
                ...
                reject(new Error(ErrorCase.BAD_REQUEST.msg));
            }
    ...
    getBubbleByJid(jid) {
        ...
        return new Promise((resolve, reject) => {
            ...
            var bubbleFound = that._bubbles.find((bubble) => {
    ...
    _onbubblepresencechanged(bubbleInfo) {
        ...
        let bubbleInMemory  = that.getBubbleByJid(bubbleInfo.jid);// that._bubbles.find((bubbleIter) => { return bubbleIter.jid === bubbleInfo.jid ; });
        if (bubbleInMemory) {
