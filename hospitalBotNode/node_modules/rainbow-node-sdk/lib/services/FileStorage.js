    ...
    getFilesReceivedInConversation(conversation) {
        ...
        return new Promise(function(resolve, reject) {
            if (!conversation) {
                ...
                that.retrieveFilesReceivedFromPeer(/* contactService.userContact.dbId */ that.rest.userId, conversation.contact.id).then(function(files) {
    ...
    getFilesReceivedInBubble(bubble) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if (!bubble) {
                ...
                that.logger.log("debug", LOG_ID + "[getFilesRcv] ::  get files received in bubble " + bubble.id + "...");

                that.retrieveReceivedFilesForRoom(bubble.id).then(function(files) {
                    if (files) {
                        that.logger.log("debug", LOG_ID + "[getFilesRcv] :: " + files.length + " files received in bubble " + bubble.id);
                    } else {
                        that.logger.log("debug", LOG_ID + "[getFilesRcv] :: No files received in bubble " + bubble.id);
                    }
                    resolve(files);
                }).catch(function(err) {
                    reject(err);
        ...
        return new Promise((resolve, reject) => {
            that.rest.retrieveReceivedFilesForRoomOrViewer(bubbleId)
                .then((response) => {
                    ...
                    that.logger.log("info", LOG_ID + "(retrieveReceivedFilesForRoom) - retrieveReceivedFilesForRoomOrViewer success");
    ...
    getFilesSentInConversation(conversation) {
        ...
        return new Promise(function(resolve, reject) {
            if (!conversation) {
                ...
                that.logger.log("info", LOG_ID + "[getFilesSnd] ::  get files sent in conversation " + conversation.id + "...");
                that.retrieveSentFiles(conversation.contact.id).then(function(files) {
    ...
    getFilesSentInBubble(bubble) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if (!bubble) {
                ...
                that.logger.log("info", LOG_ID + "[getFilesRcv] ::  get files received in bubble " + bubble.dbId + "...");

                that.retrieveSentFiles(bubble.id).then(function(files) {
                    that.logger.log("info", LOG_ID + "([getFilesSnd] ::  shared " + files.length);
                    resolve(files);
                }).catch(function(err) {
                    reject(err);
