        ...
        this._eventEmitter.iee.on("rainbow_xmppreconnected", function () {
            ...
            self._rest.reconnect().then((data) => {
                ...
                if (!self._stateManager.isCONNECTED()) {
                    self.logger.log("error", LOG_ID + " (rainbow_xmppreconnected) REST connection ", self._stateManager.FAILED, ", Error : ", err);
                    self._stateManager.transitTo(self._stateManager.FAILED);
                } else {
                    self.logger.log("warn", LOG_ID + " (rainbow_xmppreconnected) REST reconnection Error : ", err);
