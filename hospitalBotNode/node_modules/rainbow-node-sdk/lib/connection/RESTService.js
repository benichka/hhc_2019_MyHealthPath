    ...
    signin() {
        ...
        return new Promise(function(resolve, reject) {
            that.http.get("/api/rainbow/authentication/v1.0/login", that.getLoginHeader()).then(function(JSON) {
                ...
                that.logger.log("error", LOG_ID,"(signin) Error during REST signin : ", err);
                that.logger.log("debug", LOG_ID + "(signin) _exiting_");
                reject(err);
            });
        });
    ...
    deleteChannelMessage(channelId, itemId) {
        ...
        return new Promise((resolve, reject) => {
            ...
            that.http.delete("/api/rainbow/channels/v1.0/channels/" + channelId + "/items/" + itemId, that.getRequestHeader())
                ...
                .catch((err) => {
                    that.logger.log("error", LOG_ID, "[channelService] deleteChannelItem (" + channelId  + ", " + itemId + ") -- failure -- " + err.message);
                    reject(err);
                });
        });
    };
